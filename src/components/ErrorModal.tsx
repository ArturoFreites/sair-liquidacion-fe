...
export default function ErrorModal() {
    ...
    return (
        <div
            ...
            className="fixed inset-0 flex items-end justify-end z-50 px-10 py-10 bg-transparent"
        >
            <div
                onClick={(e) => e.stopPropagation()}
                className="flex items-center rounded-lg shadow-lg py-2 px-4 max-w-md bg-white"
            >
                <div className="pr-3">
